    ...
    <div className="min-h-screen">
      ...
      <div className="layout_container py-5 lg:py-10 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-3 lg:gap-5">
        <div className="md:col-span-2 lg:col-span-3 border">
          <div className="px-3 font-medium py-5 bg-gray-50 flex gap-5 items-center justify-between text-secondaryTxt">
        ...
        <div className="lg:col-span-2 h-fit">
          <div className="bg-white w-full rounded-md border p-5">
            ...
            <Link href={`/billing-info`}>
              <button
                className="bg-green-500 hover:bg-green-600 rounded-md w-full font-medium p-2 center gap-2 disabled:bg-green-200 text-white radiusM"
